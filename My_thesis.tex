...
% Задание 
% \includepdf{my_folder/task}
% \includepdf{my_folder/task-1}        % После подписания задания изменение его содержания и оформления запрещено
\input{my_folder/task} 
...
%%
%% 2. Добавления <<\textsc{Се}рдечка>> и репоста проекта в социальных сетях:
