...
\textbf{Область применения}: военные сети, IoT в удалённых районах, автономные транспортные системы.  

\textbf{Выводы}: предложенный алгоритм обеспечивает живучесть сети в условиях низкой скорости передачи и мобильности узлов, но требует кластеризации при масштабировании.
}
%%
%%
...
\begin{itemize}
	\item Node movement modeling (coordinates $x(t)$, $y(t)$ and communication radius $R \geq 10$ km)
...
\textbf{Results}:
\begin{itemize}
	\item For a 5-node network: achieved 1.5 sec transmission delay with 0\% packet loss
	\item For 15 nodes at 60 km/h: synchronization time of 131 sec (frame loss rate 22\%)
	\item Maximum network capacity: 30-50 nodes at 37 kbps, 3-5 nodes at 32 bps
\end{itemize}
