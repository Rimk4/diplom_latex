...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Плотность: 20 узлов на 1 км$^2$
    ...
    \begin{itemize}
        \item Скорость узлов: до 60 км/ч
...
\begin{itemize}
    \item Реализована имитационная модель, учитывающая мобильность узлов и ограничения энергопотребления
